...
├─ tools/{selfcheck.py, run_tests.py, test_gate_runner.py, test_guard_bash.py, test_inject_plan_pointer.py, test_conventions.py, test_evaluator.py, test_project_map.py, test_codex_adapter.py, test_promax_tokens.py}  # 자기검증 러너 + #17·#11~#13·#15·#25 테스트
